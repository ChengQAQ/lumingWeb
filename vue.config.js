...
const name = process.env.VUE_APP_TITLE || '麓鸣东方 管理端' // 网页标题
...
module.exports = {
  ...
  transpileDependencies: ['quill', 'marked', 'mavon-editor'],
  ...
  devServer: {
    ...
    proxy: {
      ...
      // 开发环境代理 - 解决CORS问题
      '/api-proxy': {
        target: 'https://admin.lumina-edu.cn:8070',
        changeOrigin: true,
        secure: true,
        pathRewrite: {
          '^/api-proxy': ''
  ...
  chainWebpack(config) {
    ...
    // 添加对mavon-editor CSS的支持
    config.module
      .rule('mavon-editor')
      .test(/\.css$/)
      .include
      .add(/node_modules\/mavon-editor/)
      .end()
      .use('style-loader')
      .loader('style-loader')
      .end()
