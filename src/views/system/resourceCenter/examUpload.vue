<template>
  <div class="app-container" :class="{ 'layout-collapsed': isSeriesCreated, 'layout-uploaded': isTotalUploaded }">
    ...
    <!-- 查询考试系列详细成绩状态模块 -->
    <el-card class="box-card search-card" style="margin-top: 30px;">
      <div slot="header" class="clearfix">
...
<script>
import { createExamSeries, uploadTotalScoreFile, uploadDetailScoreFile, getExamSeriesDetailScoreStatus, deleteExamSeries } from '@/api/system/exam'
