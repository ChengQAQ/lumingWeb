<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="subjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="显示顺序" align="center" prop="subjectSort" />
      <el-table-column label="关联星球" align="center" prop="planets" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="显示顺序" prop="subjectSort">
          <el-input-number v-model="form.subjectSort" controls-position="right" :min="0" />
        </el-form-item>
        <el-form-item label="关联星球" prop="planets">
          <el-input v-model="form.planets" placeholder="请输入关联星球，多个用逗号分隔" />
        </el-form-item>
        ...
        <el-form-item label="科目描述" prop="description">
          <el-input v-model="form.description" type="textarea" placeholder="请输入科目描述"></el-input>
        </el-form-item>
